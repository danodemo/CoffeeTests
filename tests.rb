...
class CaffeineTest < MiniTest::Test
  ...
  #this checks the Human's (tyler) method "alertness"
  ...
  #this checks 2 things that really just need to be one thing:
  #That Randy doesn't have any coffee and he needs some
  ...
  def test_humans_can_drink_coffee
    ...
    # "Triple Sh...ino" that can have other methods called on it
    assert tsmf.full?
